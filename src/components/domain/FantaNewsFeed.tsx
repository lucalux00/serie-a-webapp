...
export default function FantaNewsFeed() {
  ...
  return <section className="rounded-3xl border border-[#334155] bg-[#1E293B] p-5 shadow-2xl">
    ...
    <p className="mb-4 text-xs text-[#94A3B8]">{isRoster ? `Notizie che citano i ${data?.rosterCount ?? 0} giocatori della tua rosa.` : 'Solo infortuni, squalifiche, forma, fuori rosa e rumor di mercato sui calciatori di Serie A.'}</p>
